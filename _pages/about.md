...
permalink: /
title: "Kunqi Xu"
excerpt: "Kunqi Xu researches robotic manipulation, manipulation robustness, and physics-based simulation."
layout: default
author_profile: true
redirect_from:
  - /about/
...
Hi 👋🏻! I recently graduated from Peking University with a B.S. in Intelligence Science and Technology from the School of Electronics Engineering and Computer Science (EECS).

At PKU-Agibot Lab, I worked with [Yuanfei Wang](https://yuanfei-wang.github.io), [Ruihai Wu](https://warshallrho.github.io), and Xiaojie Zhang under the supervision of [Prof. Hao Dong](https://zsdonghao.github.io).

At the [Human-Centered Robotic Lab](https://nus-hcrl.github.io/index), National University of Singapore, I worked with [Zhenhao Huang](https://zhenhaoh.github.io), [Siyuan Luo](https://www.siyuanluo.com/), and [Ziqiu Zeng](https://ziqiu-zeng.github.io/homepage/), and was fortunate to be advised by [Prof. Fan Shi](https://fanshi14.github.io/me/).

I aspire to pursue interesting, insightful, and fundamental research. My current interests lie in manipulation dexterity and robustness, as well as physics-based simulation.

# News

- **2026.07** — Graduated from Peking University.
- **2026.07** — Named a Peking University Excellent Graduate and Beijing Excellent Graduate.
...
<div class="paper-box">
<div class="paper-box-image"><div><div class="badge">In Submission</div><img src="/images/WorldString-1.png" alt="WorldString project preview" width="100%"></div></div>
<div class="paper-box-text" markdown="1">

**WorldString: Actionable Object Representation**
...
<div class="paper-box">
<div class="paper-box-image"><div><div class="badge">ICRA 2026 Workshop</div><img src="/images/Real_IKEA-1.png" alt="Real-IKEA project preview" width="100%"></div></div>
<div class="paper-box-text" markdown="1">
...
<div class="paper-box">
<div class="paper-box-image"><div><div class="badge">ICCV 2025</div><img src="/images/AdaRPG-1.png" alt="AdaRPG project preview" width="100%"></div></div>
<div class="paper-box-text" markdown="1">
...
<div class="paper-box">
<div class="paper-box-image"><div><img src="/images/FoMax-1.png" alt="FoMoAfford project preview" width="100%"></div></div>
<div class="paper-box-text" markdown="1">
